...
QT_MOC_LITERAL(2, 25, 9), // "idChanged"
QT_MOC_LITERAL(3, 35, 1), // "y"
QT_MOC_LITERAL(4, 37, 1), // "x"
QT_MOC_LITERAL(5, 39, 2) // "id"

    },
    "PionekNiebieski\0xChanged\0idChanged\0y\0"
    "x\0id"
};
...
Q_DECL_UNUSED static void checkNotifySignalValidity_PionekNiebieski(PionekNiebieski *t) {
    t->xChanged();
    t->idChanged();
}
QT_WARNING_POP
